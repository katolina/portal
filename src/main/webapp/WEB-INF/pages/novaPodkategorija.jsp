<%-- 
    Document   : novaKategorija
    Created on : 17-Oct-2020, 13:39:29
    Author     : Kata
--%>
...
<html>
    <head>
        ...
        <title>Nova podkategorija</title>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="<c:url value = "/login"/>">Portal vesti</a>
        ...
        <div class ="container">
            ...
            <form action="${pageContext.request.contextPath}/registracija/admin/login" method = "post">
                ...
                <div class="form-group">
                    <br>
                    <label for="exampleInputNaslov">Naziv</label>
