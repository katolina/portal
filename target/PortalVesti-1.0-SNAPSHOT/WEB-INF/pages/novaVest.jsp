...
<html>
    <head>
        ...
        <link rel='stylesheet' href='${pageContext.request.contextPath}/webjars/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker3.min.css'>
    </head>
    <body>
        ...
        <div class ="container">
            ...
            <form action="${pageContext.request.contextPath}/vest/novaVest" method = "post">

                <div class="form-group">
                    <br>
                    <label for="exampleInputNaslov">Naslov</label>
                    <input type="text" class="form-control" id="exampleInputNaslov" aria-describedby="NaslovHelp">

                </div>
                <div class="form-group">

                    <label for="exampleInputNaslov">Datum</label>
                ...
                <div class="form-group">
                    <label for="exampletag">Tagovi</label>
                    <input type="text" class="form-control" id="exampletag" data-role="taginput" data-tag-trigger="Spacebar">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Tekst</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
                </div>
                <button type = "submit" class="btn btn-primary" id="sacuvaj">Sacuvaj</button>
            </form>
        </div>
